    ...
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-slate-950 scroll-smooth">
      ...
      <nav className="sticky top-0 w-full z-[100] bg-white/60 backdrop-blur-xl border-b border-slate-200/40 px-4 md:px-6 py-3">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-left">
          <div className="flex flex-col">
            <span className="text-lg md:text-xl font-black tracking-tighter uppercase italic leading-none text-slate-900">Precede Concepts</span>
          ...
          <div className="hidden md:flex items-center gap-8 text-[10px] font-black uppercase tracking-widest text-slate-400">
            ...
            <a href="/contact" className="bg-slate-900 text-white px-5 py-2 rounded-full hover:bg-blue-600 transition-all text-[9px] tracking-widest uppercase">Contact Us</a>
          </div>

          <a href="/contact" className="md:hidden bg-slate-900 text-white px-4 py-2 rounded-full text-[9px] font-black uppercase tracking-widest">Contact</a>
        </div>
      </nav>
      ...
      <header className="py-24 md:py-40 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-6xl md:text-[10rem] font-black tracking-tighter uppercase italic leading-[0.85] mb-8">
      ...
      <section id="services" className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-left">
          {[
            ...
            { title: 'Opportunities', icon: <Briefcase size={18}/>, items: ['Verified Gigs', 'Internships', 'Skills Acquisition'] },
            { title: 'Business Support', icon: <Users size={18}/>, items: ['Secretarial', 'Printing', 'Strategic Outsourcing'] },
            { title: 'Strategy & More', icon: <Lightbulb size={18}/>, items: ['Operations Planning', 'Trend Research', 'Consultancy'], dark: true },
          ].map((s, i) => (
